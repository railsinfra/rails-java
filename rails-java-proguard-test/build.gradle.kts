...
dependencies {
    testImplementation(project(":rails-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../rails-java-core/src/main/resources/META-INF/proguard/rails-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.railsinfra.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../rails-java-core/src/main/resources/META-INF/proguard/rails-java-core.pro",
