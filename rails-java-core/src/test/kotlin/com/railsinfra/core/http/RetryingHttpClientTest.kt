...
package com.railsinfra.core.http
...
import com.railsinfra.client.okhttp.OkHttpClient
import com.railsinfra.core.RequestOptions
import com.railsinfra.core.Sleeper
import com.railsinfra.errors.RailsRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw RailsRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            RailsRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
