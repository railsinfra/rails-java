...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AccountUpdateStatusParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [AccountUpdateStatusParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AccountUpdateStatusParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AccountUpdateStatusParams].
         *
