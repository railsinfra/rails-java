...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountCreateParams: AccountCreateParams) = apply {
            xEnvironment = accountCreateParams.xEnvironment
    ...
    private constructor(
        ...
        ) : this(accountType, currency, userId, environment, organizationId, mutableMapOf())
        ...
        override fun toString() =
            "Body{accountType=$accountType, currency=$currency, userId=$userId, environment=$environment, organizationId=$organizationId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun hashCode(): Int =
        Objects.hash(xEnvironment, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "AccountCreateParams{xEnvironment=$xEnvironment, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
