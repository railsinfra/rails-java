...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountDepositParams: AccountDepositParams) = apply {
            ...
            xEnvironment = accountDepositParams.xEnvironment
    ...
    override fun toString() =
        "AccountDepositParams{id=$id, xEnvironment=$xEnvironment, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
