...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AccountWithdrawParams].
         *
    ...
    /** A builder for [AccountWithdrawParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(accountWithdrawParams: AccountWithdrawParams) = apply {
            id = accountWithdrawParams.id
            xEnvironment = accountWithdrawParams.xEnvironment
            body = accountWithdrawParams.body.toBuilder()
            additionalHeaders = accountWithdrawParams.additionalHeaders.toBuilder()
            additionalQueryParams = accountWithdrawParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AccountWithdrawParams].
         *
         ...
         */
        fun build(): AccountWithdrawParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountWithdrawParams &&
            id == other.id &&
    ...
    override fun toString() =
        "AccountWithdrawParams{id=$id, xEnvironment=$xEnvironment, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
