...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AccountCloseResponse].
         *
    ...
    /** A builder for [AccountCloseResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(accountCloseResponse: AccountCloseResponse) = apply {
            id = accountCloseResponse.id
            accountNumber = accountCloseResponse.accountNumber
            accountType = accountCloseResponse.accountType
            balance = accountCloseResponse.balance
            currency = accountCloseResponse.currency
            environment = accountCloseResponse.environment
            status = accountCloseResponse.status
            userId = accountCloseResponse.userId
            adminUserId = accountCloseResponse.adminUserId
            createdAt = accountCloseResponse.createdAt
            organizationId = accountCloseResponse.organizationId
            updatedAt = accountCloseResponse.updatedAt
            userRole = accountCloseResponse.userRole
            additionalProperties = accountCloseResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AccountCloseResponse].
         *
         ...
         */
        fun build(): AccountCloseResponse =
    ...
    fun validate(): AccountCloseResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountCloseResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "AccountCloseResponse{id=$id, accountNumber=$accountNumber, accountType=$accountType, balance=$balance, currency=$currency, environment=$environment, status=$status, userId=$userId, adminUserId=$adminUserId, createdAt=$createdAt, organizationId=$organizationId, updatedAt=$updatedAt, userRole=$userRole, additionalProperties=$additionalProperties}"
}
