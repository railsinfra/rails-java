...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transactionRetrieveParams: TransactionRetrieveParams) = apply {
            id = transactionRetrieveParams.id
            xEnvironment = transactionRetrieveParams.xEnvironment
    ...
    override fun hashCode(): Int =
        Objects.hash(id, xEnvironment, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "TransactionRetrieveParams{id=$id, xEnvironment=$xEnvironment, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
