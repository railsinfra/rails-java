...
class TransactionListByAccountParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TransactionListByAccountParams = builder().build()
    ...
    /** A builder for [TransactionListByAccountParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [TransactionListByAccountParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TransactionListByAccountParams =
            TransactionListByAccountParams(
                accountId,
                limit,
