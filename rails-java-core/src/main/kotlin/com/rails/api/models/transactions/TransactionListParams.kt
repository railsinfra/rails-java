...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transactionListParams: TransactionListParams) = apply {
            organizationId = transactionListParams.organizationId
            page = transactionListParams.page
    ...
    override fun hashCode(): Int =
        Objects.hash(organizationId, page, perPage, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "TransactionListParams{organizationId=$organizationId, page=$page, perPage=$perPage, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
