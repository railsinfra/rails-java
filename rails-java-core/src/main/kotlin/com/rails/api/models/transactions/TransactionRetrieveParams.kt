...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): TransactionRetrieveParams =
            TransactionRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "TransactionRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
