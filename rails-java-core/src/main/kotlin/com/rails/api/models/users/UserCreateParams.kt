...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userCreateParams: UserCreateParams) = apply {
            xEnvironment = userCreateParams.xEnvironment
    ...
    private constructor(
        ...
        ) : this(email, firstName, lastName, password, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(email, firstName, lastName, password, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{email=$email, firstName=$firstName, lastName=$lastName, password=$password, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "UserCreateParams{xEnvironment=$xEnvironment, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
