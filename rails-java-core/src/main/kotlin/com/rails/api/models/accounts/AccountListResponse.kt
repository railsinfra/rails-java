...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountListResponse: AccountListResponse) = apply {
            id = accountListResponse.id
            accountNumber = accountListResponse.accountNumber
            accountType = accountListResponse.accountType
            balance = accountListResponse.balance
            currency = accountListResponse.currency
            environment = accountListResponse.environment
            status = accountListResponse.status
            userId = accountListResponse.userId
            adminUserId = accountListResponse.adminUserId
            createdAt = accountListResponse.createdAt
            organizationId = accountListResponse.organizationId
            updatedAt = accountListResponse.updatedAt
            userRole = accountListResponse.userRole
    ...
    override fun toString() =
        "AccountListResponse{id=$id, accountNumber=$accountNumber, accountType=$accountType, balance=$balance, currency=$currency, environment=$environment, status=$status, userId=$userId, adminUserId=$adminUserId, createdAt=$createdAt, organizationId=$organizationId, updatedAt=$updatedAt, userRole=$userRole, additionalProperties=$additionalProperties}"
}
