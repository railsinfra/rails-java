...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): AccountRetrieveParams =
            AccountRetrieveParams(id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "AccountRetrieveParams{id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
