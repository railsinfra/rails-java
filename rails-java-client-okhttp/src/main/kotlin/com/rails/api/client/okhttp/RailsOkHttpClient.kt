...
import com.rails.api.client.RailsClientImpl
...
/**
 * A class that allows building an instance of [RailsClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class RailsOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [RailsClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): RailsClient = builder().fromEnv().build()
    }

    /** A builder for [RailsOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [RailsClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RailsClient =
            RailsClientImpl(
                clientOptions
                    .httpClient(
