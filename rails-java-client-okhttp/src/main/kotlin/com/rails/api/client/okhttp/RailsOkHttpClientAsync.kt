...
package com.rails.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.rails.api.client.RailsClientAsync
import com.rails.api.client.RailsClientAsyncImpl
import com.rails.api.core.ClientOptions
import com.rails.api.core.Sleeper
import com.rails.api.core.Timeout
import com.rails.api.core.http.Headers
import com.rails.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [RailsClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class RailsOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [RailsClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): RailsClientAsync = builder().fromEnv().build()
    }

    /** A builder for [RailsOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.rails.api.core.jsonMapper]. The default is usually sufficient and rarely
        ...
        /**
         * Returns an immutable instance of [RailsClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RailsClientAsync =
